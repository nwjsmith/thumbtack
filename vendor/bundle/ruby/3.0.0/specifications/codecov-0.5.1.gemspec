...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/codecov/codecov-ruby/issues", "changelog_uri" => "https://github.com/codecov/codecov-ruby/blob/v0.5.1/CHANGELOG.md", "documentation_uri" => "http://www.rubydoc.info/gems/codecov/0.5.1", "homepage_uri" => "https://github.com/codecov/codecov-ruby", "source_code_uri" => "https://github.com/codecov/codecov-ruby" } if s.respond_to? :metadata=
